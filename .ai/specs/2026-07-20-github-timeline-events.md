...
`GET /api/github/comments/:kind/:number` — params and validation unchanged (`server.ts:1428-1439`, zod `commentsParams`, 400 on bad kind/number, `refresh=1` busts the cache). Response gains one optional field:
