...
| 6 | 6.1 | Spec: group settings by agent, descriptor-driven (amends #404) | done | 80f75c4 |
| 6 | 6.2 | `agent-descriptors.ts` — per-agent descriptor table + tests | todo | — |
| 6 | 6.3 | Rework `agent-config-section.tsx`: agent selector + per-agent pane | todo | — |
