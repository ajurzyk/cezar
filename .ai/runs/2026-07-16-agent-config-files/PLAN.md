...
| 6 | 6.6-review-fix | Sync package-lock.json (npm ci failed at head — QA finding) | done | pending |
| 6 | 6.7-review-fix | De-duplicate the tracked-file effect sentence (QA cosmetic finding) | done | pending |
