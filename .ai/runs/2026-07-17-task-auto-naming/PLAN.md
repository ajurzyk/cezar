...
| 2 | 2.1 | `src/runs/auto-name.ts` — namer prompt, strict-JSON parse, cross-check, post-validation | done | pending |
...
| 3 | 3.1 | `liveTitleUpdates` config key + `CEZ_TITLE_UPDATES` env default (ON) | todo | — |
