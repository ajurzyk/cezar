...
import { toolDisplay as webToolDisplay } from '../../web/app/src/protocol/tool-display.js';
 ...
 *
 * `web/app/src/protocol/tool-display.ts` is a hand-mirrored copy of `src/core/tool-display.ts`
